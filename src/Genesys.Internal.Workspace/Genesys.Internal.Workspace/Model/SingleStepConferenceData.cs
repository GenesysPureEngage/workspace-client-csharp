...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class SingleStepConferenceData :  IEquatable<SingleStepConferenceData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as SingleStepConferenceData);
        }

        /// <summary>
        /// Returns true if SingleStepConferenceData instances are equal
        /// </summary>
        /// <param name="input">Instance of SingleStepConferenceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SingleStepConferenceData input)
        {
            if (input == null)
                return false;
