...
namespace Genesys.Internal.Workspace.Api
{
    ...
    public interface IMediaApi : IApiAccessor
    {
        ...
        /// <returns>ApiSuccessResponse</returns>
        ApiSuccessResponse AddDocument (string mediatype, string id, FormData formData);
        ...
        /// <param name="formData"></param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        ApiResponse<ApiSuccessResponse> AddDocumentWithHttpInfo (string mediatype, string id, FormData formData);
        /// <summary>
        ...
        /// <param name="putOnHoldData"></param>
        /// <returns>ApiSuccessResponse</returns>
        ApiSuccessResponse AsyncPutOnHold (string id, PutOnHoldData putOnHoldData);
        ...
        /// <param name="putOnHoldData"></param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        ApiResponse<ApiSuccessResponse> AsyncPutOnHoldWithHttpInfo (string id, PutOnHoldData putOnHoldData);
        /// <summary>
        ...
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="mediatype">The media channel.</param>
        /// <param name="createData">Request parameters.</param>
        /// <returns>ApiSuccessResponse</returns>
        ApiSuccessResponse CreateOpenMedia (string mediatype, CreateData1 createData);
        ...
        /// <param name="createData">Request parameters.</param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        ApiResponse<ApiSuccessResponse> CreateOpenMediaWithHttpInfo (string mediatype, CreateData1 createData);
        /// <summary>
        ...
        /// <param name="mediatype">The media channel.</param>
        /// <param name="id">The ID of the interaction.</param>
        /// <param name="pullInteractionFromWorkbinData"> (optional)</param>
        /// <returns>ApiSuccessResponse</returns>
        ApiSuccessResponse PullInteractionFromWorkbin (string mediatype, string id, PullInteractionFromWorkbinData pullInteractionFromWorkbinData = null);
        ...
        /// <param name="pullInteractionFromWorkbinData"> (optional)</param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        ApiResponse<ApiSuccessResponse> PullInteractionFromWorkbinWithHttpInfo (string mediatype, string id, PullInteractionFromWorkbinData pullInteractionFromWorkbinData = null);
        /// <summary>
        ...
        /// <param name="formData"></param>
        /// <returns>Task of ApiSuccessResponse</returns>
        System.Threading.Tasks.Task<ApiSuccessResponse> AddDocumentAsync (string mediatype, string id, FormData formData);
        ...
        /// <param name="formData"></param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> AddDocumentAsyncWithHttpInfo (string mediatype, string id, FormData formData);
        /// <summary>
        /// Assign the contact to the open interaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="putOnHoldData"></param>
        /// <returns>Task of ApiSuccessResponse</returns>
        System.Threading.Tasks.Task<ApiSuccessResponse> AsyncPutOnHoldAsync (string id, PutOnHoldData putOnHoldData);
        ...
        /// <param name="putOnHoldData"></param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> AsyncPutOnHoldAsyncWithHttpInfo (string id, PutOnHoldData putOnHoldData);
        /// <summary>
        /// Attach user data to the interaction.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="createData">Request parameters.</param>
        /// <returns>Task of ApiSuccessResponse</returns>
        System.Threading.Tasks.Task<ApiSuccessResponse> CreateOpenMediaAsync (string mediatype, CreateData1 createData);
        ...
        /// <param name="createData">Request parameters.</param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> CreateOpenMediaAsyncWithHttpInfo (string mediatype, CreateData1 createData);
        /// <summary>
        /// Remove key/value pairs from user data.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pullInteractionFromWorkbinData"> (optional)</param>
        /// <returns>Task of ApiSuccessResponse</returns>
        System.Threading.Tasks.Task<ApiSuccessResponse> PullInteractionFromWorkbinAsync (string mediatype, string id, PullInteractionFromWorkbinData pullInteractionFromWorkbinData = null);
        ...
        /// <param name="pullInteractionFromWorkbinData"> (optional)</param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> PullInteractionFromWorkbinAsyncWithHttpInfo (string mediatype, string id, PullInteractionFromWorkbinData pullInteractionFromWorkbinData = null);
        /// <summary>
        /// Set the agent state to Ready.
        /// </summary>
        /// <remarks>
    ...
    public partial class MediaApi : IMediaApi
    {
        ...
        /// <param name="formData"></param>
        /// <returns>ApiSuccessResponse</returns>
        public ApiSuccessResponse AddDocument (string mediatype, string id, FormData formData)
        {
             ApiResponse<ApiSuccessResponse> localVarResponse = AddDocumentWithHttpInfo(mediatype, id, formData);
             return localVarResponse.Data;
        }
        ...
        /// <param name="formData"></param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        public ApiResponse< ApiSuccessResponse > AddDocumentWithHttpInfo (string mediatype, string id, FormData formData)
        {
            // verify the required parameter 'mediatype' is set
            if (mediatype == null)
                throw new ApiException(400, "Missing required parameter 'mediatype' when calling MediaApi->AddDocument");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling MediaApi->AddDocument");
            // verify the required parameter 'formData' is set
            if (formData == null)
                throw new ApiException(400, "Missing required parameter 'formData' when calling MediaApi->AddDocument");

            var localVarPath = "/media/{mediatype}/interactions/{id}/add-document";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (mediatype != null) localVarPathParams.Add("mediatype", Configuration.ApiClient.ParameterToString(mediatype)); // path parameter
            if (id != null) localVarPathParams.Add("id", Configuration.ApiClient.ParameterToString(id)); // path parameter
            if (formData != null && formData.GetType() != typeof(byte[]))
            {
                localVarPostBody = Configuration.ApiClient.Serialize(formData); // http body (model) parameter
            }
            else
            {
                localVarPostBody = formData; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("AddDocument", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="formData"></param>
        /// <returns>Task of ApiSuccessResponse</returns>
        public async System.Threading.Tasks.Task<ApiSuccessResponse> AddDocumentAsync (string mediatype, string id, FormData formData)
        {
             ApiResponse<ApiSuccessResponse> localVarResponse = await AddDocumentAsyncWithHttpInfo(mediatype, id, formData);
             return localVarResponse.Data;
        ...
        /// <param name="formData"></param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> AddDocumentAsyncWithHttpInfo (string mediatype, string id, FormData formData)
        {
            // verify the required parameter 'mediatype' is set
            if (mediatype == null)
                throw new ApiException(400, "Missing required parameter 'mediatype' when calling MediaApi->AddDocument");
        ...
        /// <summary>
        /// Put the interaction chat on hold Put the interaction chat on hold.
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The ID of the interaction.</param>
        /// <param name="putOnHoldData"></param>
        /// <returns>ApiSuccessResponse</returns>
        public ApiSuccessResponse AsyncPutOnHold (string id, PutOnHoldData putOnHoldData)
        {
             ApiResponse<ApiSuccessResponse> localVarResponse = AsyncPutOnHoldWithHttpInfo(id, putOnHoldData);
             return localVarResponse.Data;
        }
        ...
        /// <param name="putOnHoldData"></param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        public ApiResponse< ApiSuccessResponse > AsyncPutOnHoldWithHttpInfo (string id, PutOnHoldData putOnHoldData)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling MediaApi->AsyncPutOnHold");
            // verify the required parameter 'putOnHoldData' is set
            if (putOnHoldData == null)
                throw new ApiException(400, "Missing required parameter 'putOnHoldData' when calling MediaApi->AsyncPutOnHold");

            var localVarPath = "/media/chat/interactions/{id}/put-on-hold";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (id != null) localVarPathParams.Add("id", Configuration.ApiClient.ParameterToString(id)); // path parameter
            if (putOnHoldData != null && putOnHoldData.GetType() != typeof(byte[]))
            {
                localVarPostBody = Configuration.ApiClient.Serialize(putOnHoldData); // http body (model) parameter
            }
            else
            {
                localVarPostBody = putOnHoldData; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("AsyncPutOnHold", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="putOnHoldData"></param>
        /// <returns>Task of ApiSuccessResponse</returns>
        public async System.Threading.Tasks.Task<ApiSuccessResponse> AsyncPutOnHoldAsync (string id, PutOnHoldData putOnHoldData)
        {
             ApiResponse<ApiSuccessResponse> localVarResponse = await AsyncPutOnHoldAsyncWithHttpInfo(id, putOnHoldData);
             return localVarResponse.Data;
        ...
        /// <param name="putOnHoldData"></param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> AsyncPutOnHoldAsyncWithHttpInfo (string id, PutOnHoldData putOnHoldData)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling MediaApi->AsyncPutOnHold");
        ...
        /// <param name="createData">Request parameters.</param>
        /// <returns>ApiSuccessResponse</returns>
        public ApiSuccessResponse CreateOpenMedia (string mediatype, CreateData1 createData)
        {
             ApiResponse<ApiSuccessResponse> localVarResponse = CreateOpenMediaWithHttpInfo(mediatype, createData);
             return localVarResponse.Data;
        }
        ...
        /// <param name="createData">Request parameters.</param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        public ApiResponse< ApiSuccessResponse > CreateOpenMediaWithHttpInfo (string mediatype, CreateData1 createData)
        {
            // verify the required parameter 'mediatype' is set
            if (mediatype == null)
                throw new ApiException(400, "Missing required parameter 'mediatype' when calling MediaApi->CreateOpenMedia");
            // verify the required parameter 'createData' is set
            if (createData == null)
                throw new ApiException(400, "Missing required parameter 'createData' when calling MediaApi->CreateOpenMedia");

            var localVarPath = "/media/{mediatype}/interactions/create";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("CreateOpenMedia", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="createData">Request parameters.</param>
        /// <returns>Task of ApiSuccessResponse</returns>
        public async System.Threading.Tasks.Task<ApiSuccessResponse> CreateOpenMediaAsync (string mediatype, CreateData1 createData)
        {
             ApiResponse<ApiSuccessResponse> localVarResponse = await CreateOpenMediaAsyncWithHttpInfo(mediatype, createData);
             return localVarResponse.Data;
        ...
        /// <param name="createData">Request parameters.</param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> CreateOpenMediaAsyncWithHttpInfo (string mediatype, CreateData1 createData)
        {
            // verify the required parameter 'mediatype' is set
            if (mediatype == null)
                throw new ApiException(400, "Missing required parameter 'mediatype' when calling MediaApi->CreateOpenMedia");
        ...
        /// <summary>
        /// Log out of all media channels. Log out the current agent on all media channels. You can make a [/media/{mediatype}/ready](/reference/workspace/Media/index.html#readyAgentState) or [/media/{mediatype}/not-ready](/reference/workspace/Media/index.html#notReadyAgentState) request to log in to the media channel again.
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiSuccessResponse</returns>
        ...
        /// <param name="pullInteractionFromWorkbinData"> (optional)</param>
        /// <returns>ApiSuccessResponse</returns>
        public ApiSuccessResponse PullInteractionFromWorkbin (string mediatype, string id, PullInteractionFromWorkbinData pullInteractionFromWorkbinData = null)
        {
             ApiResponse<ApiSuccessResponse> localVarResponse = PullInteractionFromWorkbinWithHttpInfo(mediatype, id, pullInteractionFromWorkbinData);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pullInteractionFromWorkbinData"> (optional)</param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        public ApiResponse< ApiSuccessResponse > PullInteractionFromWorkbinWithHttpInfo (string mediatype, string id, PullInteractionFromWorkbinData pullInteractionFromWorkbinData = null)
        {
            // verify the required parameter 'mediatype' is set
            if (mediatype == null)
                throw new ApiException(400, "Missing required parameter 'mediatype' when calling MediaApi->PullInteractionFromWorkbin");
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling MediaApi->PullInteractionFromWorkbin");

            var localVarPath = "/media/{mediatype}/interactions/{id}/pull";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="pullInteractionFromWorkbinData"> (optional)</param>
        /// <returns>Task of ApiSuccessResponse</returns>
        public async System.Threading.Tasks.Task<ApiSuccessResponse> PullInteractionFromWorkbinAsync (string mediatype, string id, PullInteractionFromWorkbinData pullInteractionFromWorkbinData = null)
        {
             ApiResponse<ApiSuccessResponse> localVarResponse = await PullInteractionFromWorkbinAsyncWithHttpInfo(mediatype, id, pullInteractionFromWorkbinData);
             return localVarResponse.Data;
        ...
        /// <param name="pullInteractionFromWorkbinData"> (optional)</param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> PullInteractionFromWorkbinAsyncWithHttpInfo (string mediatype, string id, PullInteractionFromWorkbinData pullInteractionFromWorkbinData = null)
        {
            // verify the required parameter 'mediatype' is set
            if (mediatype == null)
                throw new ApiException(400, "Missing required parameter 'mediatype' when calling MediaApi->PullInteractionFromWorkbin");
