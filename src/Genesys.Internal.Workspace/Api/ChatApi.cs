...
namespace Genesys.Internal.Workspace.Api
{
    ...
    public interface IChatApi : IApiAccessor
    {
        ...
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The ID of the chat interaction.</param>
        /// <param name="asyncResumeData">Request parameters.</param>
        /// <returns>ApiSuccessResponse</returns>
        ApiSuccessResponse AsyncResume (string id, AsyncResumeData asyncResumeData);
        ...
        /// <param name="asyncResumeData">Request parameters.</param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        ApiResponse<ApiSuccessResponse> AsyncResumeWithHttpInfo (string id, AsyncResumeData asyncResumeData);
        /// <summary>
        ...
        /// <param name="asyncResumeData">Request parameters.</param>
        /// <returns>Task of ApiSuccessResponse</returns>
        System.Threading.Tasks.Task<ApiSuccessResponse> AsyncResumeAsync (string id, AsyncResumeData asyncResumeData);
        ...
        /// <param name="asyncResumeData">Request parameters.</param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> AsyncResumeAsyncWithHttpInfo (string id, AsyncResumeData asyncResumeData);
        /// <summary>
        /// Cancel a chat consultation request.
        /// </summary>
        /// <remarks>
    ...
    public partial class ChatApi : IChatApi
    {
        ...
        /// <param name="asyncResumeData">Request parameters.</param>
        /// <returns>ApiSuccessResponse</returns>
        public ApiSuccessResponse AsyncResume (string id, AsyncResumeData asyncResumeData)
        {
        ...
        /// <param name="asyncResumeData">Request parameters.</param>
        /// <returns>ApiResponse of ApiSuccessResponse</returns>
        public ApiResponse< ApiSuccessResponse > AsyncResumeWithHttpInfo (string id, AsyncResumeData asyncResumeData)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            if (asyncResumeData == null)
                throw new ApiException(400, "Missing required parameter 'asyncResumeData' when calling ChatApi->AsyncResume");
        ...
        /// <param name="asyncResumeData">Request parameters.</param>
        /// <returns>Task of ApiSuccessResponse</returns>
        public async System.Threading.Tasks.Task<ApiSuccessResponse> AsyncResumeAsync (string id, AsyncResumeData asyncResumeData)
        {
        ...
        /// <param name="asyncResumeData">Request parameters.</param>
        /// <returns>Task of ApiResponse (ApiSuccessResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApiSuccessResponse>> AsyncResumeAsyncWithHttpInfo (string id, AsyncResumeData asyncResumeData)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ChatApi->AsyncResume");
