...
namespace Genesys.Internal.Workspace.Api
{
    ...
    public partial class ReportingApi : IReportingApi
    {
        ...
        /// <summary>
        /// Subscribe to statistics. Open a subscription for the specified set of statistics. The values are returned when you request them using [/reporting/subscriptions/{subscriptionId}](/reference/workspace/Reporting/index.html#peek).
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="statisticsSubscribeData">The collection of statistics you want to include in your subscription.</param>
        /// <returns>InlineResponse2002</returns>
