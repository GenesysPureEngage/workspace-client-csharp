...
namespace Genesys.Internal.Workspace.Api
{
    ...
    public interface ISessionApi : IApiAccessor
    {
        ...
        ApiResponse<Object> AuthKeepAliveWithHttpInfo ();
        /// <summary>
        ...
        /// <param name="authorization">Bearer authorization. For example, \&quot;Authorization&amp;colon; Bearer access_token\&quot;. (optional)</param>
        /// <returns>ApiSuccessResponse</returns>
        ...
        /// <param name="type">The application type requesting the login. (optional)</param>
        /// <param name="locale">The current locale of the app. (optional)</param>
        /// <returns></returns>
        void Login (string redirectUri, string type = null, string locale = null);
        ...
        /// <param name="locale">The current locale of the app. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> LoginWithHttpInfo (string redirectUri, string type = null, string locale = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task AuthKeepAliveAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AuthKeepAliveAsyncWithHttpInfo ();
        /// <summary>
        /// Get the business attribute hierarchy.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="locale">The current locale of the app. (optional)</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task LoginAsync (string redirectUri, string type = null, string locale = null);
        ...
        /// <param name="locale">The current locale of the app. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> LoginAsyncWithHttpInfo (string redirectUri, string type = null, string locale = null);
        /// <summary>
        /// Log out of activated channels and end the session.
        /// </summary>
        /// <remarks>
    ...
    public partial class SessionApi : ISessionApi
    {
        ...
        /// <summary>
        /// Activate channels for the user with the specified resources. Activate the specified channels using the provided resources. If the channels are successfully activated, Workspace sends additional information about the state of active resources (DNs, channels) via events. The resources you provide are associated with the agent for the duration of the session. You should send this request after making an [/initialize-workspace](/reference/workspace/Session/index.html#initializeWorkspace) request and getting the WorkspaceInitializationComplete message through CometD.
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="channelsData"></param>
        /// <returns>ApiSuccessResponse</returns>
        ...
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> AuthKeepAliveWithHttpInfo ()
        {

            var localVarPath = "/auth-keep-alive";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("AuthKeepAlive", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task AuthKeepAliveAsync ()
        {
             await AuthKeepAliveAsyncWithHttpInfo();
        ...
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> AuthKeepAliveAsyncWithHttpInfo ()
        {
        ...
        /// <summary>
        /// Retrieve and register an authorization token. Retrieve the authorization token using the authorization code. Workspace then registers the token and prepares the user&#39;s environment.
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="code">The authorization code. You must include this parameter for the [Authorization Code Grant flow](/reference/authentication/). (optional)</param>
        /// <param name="redirectUri">The same redirect URI you used in the initial login step. You must include this parameter for the [Authorization Code Grant flow](/reference/authentication/). (optional)</param>
        ...
        /// <param name="locale">The current locale of the app. (optional)</param>
        /// <returns></returns>
        public void Login (string redirectUri, string type = null, string locale = null)
        {
        ...
        /// <param name="locale">The current locale of the app. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> LoginWithHttpInfo (string redirectUri, string type = null, string locale = null)
        {
        ...
        /// <param name="locale">The current locale of the app. (optional)</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task LoginAsync (string redirectUri, string type = null, string locale = null)
        {
             await LoginAsyncWithHttpInfo(redirectUri, type, locale);
        ...
        /// <param name="locale">The current locale of the app. (optional)</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> LoginAsyncWithHttpInfo (string redirectUri, string type = null, string locale = null)
        {
            // verify the required parameter 'redirectUri' is set
            if (redirectUri == null)
                throw new ApiException(400, "Missing required parameter 'redirectUri' when calling SessionApi->Login");
        ...
        /// <summary>
        /// Log out of activated channels and end the session. End the current agent&#39;s session. This request logs out the agent on all activated channels, ends the HTTP session, and cleans up related resources. Genesys recommends that you first disconnect CometD and then make this request. After you end the session, you&#39;ll need to make a login request before making any new calls to the API.
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiSuccessResponse</returns>
