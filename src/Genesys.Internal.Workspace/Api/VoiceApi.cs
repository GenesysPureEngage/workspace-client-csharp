...
namespace Genesys.Internal.Workspace.Api
{
    ...
    public partial class VoiceApi : IVoiceApi
    {
        ...
        /// <summary>
        /// Alternate between calls. Alternate two calls so that you retrieve a call on hold and place the established call on hold instead. This is a shortcut for doing [/voice/calls/{id}/hold](/reference/workspace/Voice/index.html#hold) and [/voice/calls/{id}/retrieve](/reference/workspace/Voice/index.html#retrieve) separately.
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The connection ID of the established call that should be placed on hold.</param>
        /// <param name="alternateData"></param>
        ...
        /// <summary>
        /// Complete the specified call. Complete the specified call by adding information to its user data after it has been released. You should make this request on released calls if you set automatic complete to false in [/activate-channels](/reference/workspace/Session/index.html#activateChannels).
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The connection ID of the call.</param>
        /// <param name="userData">Key/value data to include with the call.</param>
        ...
        /// <summary>
        /// Initiate a conference. Initiate a two-step conference to the specified destination. This places the existing call on hold and creates a new call in the dialing state (step 1). After initiating the conference you can use [/voice/calls/{id}/complete-conference](/reference/workspace/Voice/index.html#completeConference) to complete the conference and bring all parties into the same call (step 2).
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The connection ID of the call to start the conference from. This call will be placed on hold.</param>
        /// <param name="initiateConferenceData"></param>
        ...
        /// <summary>
        /// Initiate a transfer. Initiate a two-step transfer by placing the first call on hold and dialing the destination number (step 1). After initiating the transfer, you can use [/voice/calls/{id}/complete-transfer](/reference/workspace/Voice/index.html#completeTransfer) to complete the transfer (step 2).
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The connection ID of the call to be transferred. This call will be placed on hold.</param>
        /// <param name="initiateTransferData"></param>
        ...
        /// <summary>
        /// Log out of the voice channel. Log out the current agent on the voice channel. This request is typically paired with [/voice/login](/reference/workspace/Voice/index.html#loginVoice)&amp;mdash;together they let you login/logout an agent on the voice channel without logging out of the entire session.
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiSuccessResponse</returns>
        ...
        /// <summary>
        /// Reconnect a call. Reconnect the specified call. This releases the established call and retrieves the held call in one step. This is a quick way to to do [/voice/calls/{id}/release](/reference/workspace/Voice/index.html#release) and [/voice/calls/{id}/retrieve](/reference/workspace/Voice/index.html#retrieve).
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The connection ID of the established call (will be released).</param>
        /// <param name="reconnectData"></param>
        ...
        /// <summary>
        /// Start monitoring an agent. Start supervisor monitoring of an agent. Use the parameters to specify how the monitoring should behave. Once you&#39;ve enabled monitoring, you can change the monitoring mode using [/voice/calls/{id}/switch-to-listen-in (Mute)](/reference/workspace/Voice/index.html#switchToListenIn), [/voice/calls/{id}/switch-to-coaching (Coach)](/reference/workspace/Voice/index.html#switchToCoaching), and [/voice/calls/{id}/switch-to-barge-in (Connect)](/reference/workspace/Voice/index.html#switchToBargeIn).
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="startMonitoringData"></param>
        /// <returns>ApiSuccessResponse</returns>
        ...
        /// <summary>
        /// Start recording the specified call. Start recording the specified call. Recording stops when the call is completed or you send [/voice/calls/{id}/stop-recording](/reference/workspace/Voice/index.html#stopRecording) on either the call or the DN.
        /// </summary>
        /// <exception cref="Genesys.Internal.Workspace.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The connection ID of the call.</param>
        /// <returns>ApiSuccessResponse</returns>
