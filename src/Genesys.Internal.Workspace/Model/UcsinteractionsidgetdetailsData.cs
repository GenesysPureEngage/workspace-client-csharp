...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class UcsinteractionsidgetdetailsData :  IEquatable<UcsinteractionsidgetdetailsData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UcsinteractionsidgetdetailsData);
        }

        /// <summary>
        /// Returns true if UcsinteractionsidgetdetailsData instances are equal
        /// </summary>
        /// <param name="other">Instance of UcsinteractionsidgetdetailsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UcsinteractionsidgetdetailsData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
