...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class SupervisorvoiceoperationNameData :  IEquatable<SupervisorvoiceoperationNameData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SupervisorvoiceoperationNameData);
        }

        /// <summary>
        /// Returns true if SupervisorvoiceoperationNameData instances are equal
        /// </summary>
        /// <param name="other">Instance of SupervisorvoiceoperationNameData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupervisorvoiceoperationNameData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
