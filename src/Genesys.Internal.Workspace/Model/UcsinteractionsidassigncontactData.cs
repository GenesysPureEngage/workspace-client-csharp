...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class UcsinteractionsidassigncontactData :  IEquatable<UcsinteractionsidassigncontactData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UcsinteractionsidassigncontactData);
        }

        /// <summary>
        /// Returns true if UcsinteractionsidassigncontactData instances are equal
        /// </summary>
        /// <param name="other">Instance of UcsinteractionsidassigncontactData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UcsinteractionsidassigncontactData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
