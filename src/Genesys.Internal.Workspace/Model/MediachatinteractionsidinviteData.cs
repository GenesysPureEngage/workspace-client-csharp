...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class MediachatinteractionsidinviteData :  IEquatable<MediachatinteractionsidinviteData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MediachatinteractionsidinviteData);
        }

        /// <summary>
        /// Returns true if MediachatinteractionsidinviteData instances are equal
        /// </summary>
        /// <param name="other">Instance of MediachatinteractionsidinviteData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediachatinteractionsidinviteData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
