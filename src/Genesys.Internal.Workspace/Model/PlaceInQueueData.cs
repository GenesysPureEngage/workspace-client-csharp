...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class PlaceInQueueData :  IEquatable<PlaceInQueueData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PlaceInQueueData);
        }

        /// <summary>
        /// Returns true if PlaceInQueueData instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaceInQueueData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceInQueueData input)
        {
            if (input == null)
                return false;
