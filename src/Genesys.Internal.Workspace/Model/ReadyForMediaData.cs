...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class ReadyForMediaData :  IEquatable<ReadyForMediaData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ReadyForMediaData);
        }

        /// <summary>
        /// Returns true if ReadyForMediaData instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadyForMediaData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadyForMediaData input)
        {
            if (input == null)
                return false;
