...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class CallCommentData :  IEquatable<CallCommentData>, IValidatableObject
    {
        ...
        public CallCommentData(UcsinteractionsidsetcommentData Data = default(UcsinteractionsidsetcommentData))
        {
            ...
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for CallCommentData and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        {
            return this.Equals(input as CallCommentData);
        }

        /// <summary>
        /// Returns true if CallCommentData instances are equal
        /// </summary>
        /// <param name="input">Instance of CallCommentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallCommentData input)
        {
            if (input == null)
                return false;
