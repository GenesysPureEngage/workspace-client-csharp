...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class CreateContactData :  IEquatable<CreateContactData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateContactData);
        }

        /// <summary>
        /// Returns true if CreateContactData instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateContactData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateContactData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
