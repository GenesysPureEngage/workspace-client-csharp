...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class NotReadyForAgentData :  IEquatable<NotReadyForAgentData>, IValidatableObject
    {
        ...
        protected NotReadyForAgentData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotReadyForAgentData" /> class.
        /// </summary>
        ...
        public NotReadyForAgentData(MedianotreadyData Data = default(MedianotreadyData))
        {
            ...
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for NotReadyForAgentData and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        {
            return this.Equals(input as NotReadyForAgentData);
        }

        /// <summary>
        /// Returns true if NotReadyForAgentData instances are equal
        /// </summary>
        /// <param name="input">Instance of NotReadyForAgentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotReadyForAgentData input)
        {
            if (input == null)
                return false;
