...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class MediachatinteractionsidsendcustomnotificationData :  IEquatable<MediachatinteractionsidsendcustomnotificationData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as MediachatinteractionsidsendcustomnotificationData);
        }

        /// <summary>
        /// Returns true if MediachatinteractionsidsendcustomnotificationData instances are equal
        /// </summary>
        /// <param name="input">Instance of MediachatinteractionsidsendcustomnotificationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediachatinteractionsidsendcustomnotificationData input)
        {
            if (input == null)
                return false;
