...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class RemoveFromConferenceData :  IEquatable<RemoveFromConferenceData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RemoveFromConferenceData);
        }

        /// <summary>
        /// Returns true if RemoveFromConferenceData instances are equal
        /// </summary>
        /// <param name="other">Instance of RemoveFromConferenceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveFromConferenceData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
