...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class MediachatinteractionsidconsultData :  IEquatable<MediachatinteractionsidconsultData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MediachatinteractionsidconsultData);
        }

        /// <summary>
        /// Returns true if MediachatinteractionsidconsultData instances are equal
        /// </summary>
        /// <param name="other">Instance of MediachatinteractionsidconsultData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediachatinteractionsidconsultData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
