...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class AcceptData5 :  IEquatable<AcceptData5>, IValidatableObject
    {
        ...
        public AcceptData5(MediaemailinteractionsidacceptData Data = default(MediaemailinteractionsidacceptData))
        {
            this.Data = Data;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AcceptData5);
        }

        /// <summary>
        /// Returns true if AcceptData5 instances are equal
        /// </summary>
        /// <param name="other">Instance of AcceptData5 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AcceptData5 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
