...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class AlternateData :  IEquatable<AlternateData>, IValidatableObject
    {
        ...
        public AlternateData(VoicecallsidalternateData Data = default(VoicecallsidalternateData))
        {
            ...
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for AlternateData and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        {
            return this.Equals(input as AlternateData);
        }

        /// <summary>
        /// Returns true if AlternateData instances are equal
        /// </summary>
        /// <param name="input">Instance of AlternateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlternateData input)
        {
            if (input == null)
                return false;
