...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class PersonalFavoriteData :  IEquatable<PersonalFavoriteData>, IValidatableObject
    {
        ...
        protected PersonalFavoriteData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonalFavoriteData" /> class.
        /// </summary>
        ...
        public PersonalFavoriteData(TargetspersonalfavoritessaveData Data = default(TargetspersonalfavoritessaveData))
        {
            ...
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for PersonalFavoriteData and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        {
            return this.Equals(input as PersonalFavoriteData);
        }

        /// <summary>
        /// Returns true if PersonalFavoriteData instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonalFavoriteData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonalFavoriteData input)
        {
            if (input == null)
                return false;
