...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class MediaemailinteractionsidreplyData :  IEquatable<MediaemailinteractionsidreplyData>, IValidatableObject
    {
        ...
        /// <param name="To">The address mail of to address. If the field is not defined. The to is reply addresse speficied in inboud or from address if reply is not defined..</param>
        ...
        public MediaemailinteractionsidreplyData(string Queue = default(string), string From = default(string), string To = default(string), string Body = default(string), string BodyAsPlainText = default(string), string Mime = default(string), string Subject = default(string), List<Kvpair> UserData = default(List<Kvpair>))
        {
        ...
        /// </summary>
        /// <value>The address mail of to address. If the field is not defined. The to is reply addresse speficied in inboud or from address if reply is not defined.</value>
