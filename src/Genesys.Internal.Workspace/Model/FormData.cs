...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class FormData :  IEquatable<FormData>, IValidatableObject
    {
        ...
        public FormData(MediamediatypeinteractionsidadddocumentData Data = default(MediamediatypeinteractionsidadddocumentData))
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for FormData and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        public MediamediatypeinteractionsidadddocumentData Data { get; set; }
