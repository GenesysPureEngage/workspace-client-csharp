...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class MediamediatypeinteractionsidtransferagentData :  IEquatable<MediamediatypeinteractionsidtransferagentData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MediamediatypeinteractionsidtransferagentData);
        }

        /// <summary>
        /// Returns true if MediamediatypeinteractionsidtransferagentData instances are equal
        /// </summary>
        /// <param name="other">Instance of MediamediatypeinteractionsidtransferagentData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediamediatypeinteractionsidtransferagentData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
