...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class MediamediatypestopmonitoringData :  IEquatable<MediamediatypestopmonitoringData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MediamediatypestopmonitoringData);
        }

        /// <summary>
        /// Returns true if MediamediatypestopmonitoringData instances are equal
        /// </summary>
        /// <param name="other">Instance of MediamediatypestopmonitoringData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediamediatypestopmonitoringData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
