...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class IdentifyContactData :  IEquatable<IdentifyContactData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as IdentifyContactData);
        }

        /// <summary>
        /// Returns true if IdentifyContactData instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentifyContactData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentifyContactData input)
        {
            if (input == null)
                return false;
