...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class WorkbinsworkbinIdsubscribeData :  IEquatable<WorkbinsworkbinIdsubscribeData>, IValidatableObject
    {
        ...
        public WorkbinsworkbinIdsubscribeData(string OwnerId = default(string))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WorkbinsworkbinIdsubscribeData);
        }

        /// <summary>
        /// Returns true if WorkbinsworkbinIdsubscribeData instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkbinsworkbinIdsubscribeData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkbinsworkbinIdsubscribeData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
