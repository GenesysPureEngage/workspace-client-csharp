...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class VoicecallsidreconnectData :  IEquatable<VoicecallsidreconnectData>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="VoicecallsidreconnectData" /> class.
        /// </summary>
        /// <param name="HeldConnId">The ID of the held call (will be retrieved). (required).</param>
        ...
        /// </summary>
        /// <value>The ID of the held call (will be retrieved).</value>
        ...
        {
            return this.Equals(input as VoicecallsidreconnectData);
        }

        /// <summary>
        /// Returns true if VoicecallsidreconnectData instances are equal
        /// </summary>
        /// <param name="input">Instance of VoicecallsidreconnectData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicecallsidreconnectData input)
        {
            if (input == null)
                return false;
