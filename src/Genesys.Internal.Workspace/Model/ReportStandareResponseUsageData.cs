...
namespace Genesys.Internal.Workspace.Model
{
    ...
    public partial class ReportStandareResponseUsageData :  IEquatable<ReportStandareResponseUsageData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReportStandareResponseUsageData);
        }

        /// <summary>
        /// Returns true if ReportStandareResponseUsageData instances are equal
        /// </summary>
        /// <param name="other">Instance of ReportStandareResponseUsageData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportStandareResponseUsageData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
