...
namespace Genesys.Workspace.Model
{
    ...
    public partial class VoicecallsidcompletetransferData :  IEquatable<VoicecallsidcompletetransferData>, IValidatableObject
    {
        ...
        protected VoicecallsidcompletetransferData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicecallsidcompletetransferData" /> class.
        /// </summary>
        /// <param name="CurrentConnId">Connection identifier of the consultation call; will be deleted after completion of operation. (required).</param>
        ...
        public VoicecallsidcompletetransferData(string CurrentConnId = default(string), List<Kvpair> Reasons = default(List<Kvpair>), List<Kvpair> Extensions = default(List<Kvpair>))
        {
            // to ensure "CurrentConnId" is required (not null)
            if (CurrentConnId == null)
            {
                throw new InvalidDataException("CurrentConnId is a required property for VoicecallsidcompletetransferData and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Connection identifier of the consultation call; will be deleted after completion of operation.</value>
