...
namespace Genesys.Workspace.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoicecallsidredirectcallData :  IEquatable<VoicecallsidredirectcallData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicecallsidredirectcallData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VoicecallsidredirectcallData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicecallsidredirectcallData" /> class.
        /// </summary>
        ...
        public VoicecallsidredirectcallData(string Destination = default(string), List<Kvpair> Reasons = default(List<Kvpair>), List<Kvpair> Extensions = default(List<Kvpair>))
        {
            // to ensure "Destination" is required (not null)
            if (Destination == null)
            {
                throw new InvalidDataException("Destination is a required property for VoicecallsidredirectcallData and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VoicecallsidredirectcallData);
        }

        /// <summary>
        /// Returns true if VoicecallsidredirectcallData instances are equal
        /// </summary>
        /// <param name="other">Instance of VoicecallsidredirectcallData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicecallsidredirectcallData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
