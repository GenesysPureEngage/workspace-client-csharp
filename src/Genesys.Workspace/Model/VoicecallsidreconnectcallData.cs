...
namespace Genesys.Workspace.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoicecallsidreconnectcallData :  IEquatable<VoicecallsidreconnectcallData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicecallsidreconnectcallData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VoicecallsidreconnectcallData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicecallsidreconnectcallData" /> class.
        /// </summary>
        /// <param name="CurrentConnId">Connection identifier of the active call from which the telephony object in question should be released. (required).</param>
        ...
        public VoicecallsidreconnectcallData(string CurrentConnId = default(string), List<Kvpair> Reasons = default(List<Kvpair>), List<Kvpair> Extensions = default(List<Kvpair>))
        {
            // to ensure "CurrentConnId" is required (not null)
            if (CurrentConnId == null)
            {
                throw new InvalidDataException("CurrentConnId is a required property for VoicecallsidreconnectcallData and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VoicecallsidreconnectcallData);
        }

        /// <summary>
        /// Returns true if VoicecallsidreconnectcallData instances are equal
        /// </summary>
        /// <param name="other">Instance of VoicecallsidreconnectcallData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicecallsidreconnectcallData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
