...
namespace Genesys.Workspace.Model
{
    ...
    public partial class VoicecallsidsinglestepconferenceData :  IEquatable<VoicecallsidsinglestepconferenceData>, IValidatableObject
    {
        ...
        public VoicecallsidsinglestepconferenceData(List<Kvpair> Reasons = default(List<Kvpair>), List<Kvpair> UserData = default(List<Kvpair>), string Destination = default(string), List<Kvpair> Extensions = default(List<Kvpair>), string Location = default(string))
        {
