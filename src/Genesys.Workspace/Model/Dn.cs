...
namespace Genesys.Workspace.Model
{
    public class Dn
    {
        ...
        {
            return string.Format("[Dn: number={0}, switchName={1}, agentId={2}, telephonyNetwork={3}, agentState={4}, workMode={5}, reasons={6}, forwardTo={7}, dnd={8}, capabilities={9}]", number, switchName, agentId, telephonyNetwork, agentState, workMode, reasons, forwardTo, dnd, CapabilitiesAsString(capabilities));
        }
