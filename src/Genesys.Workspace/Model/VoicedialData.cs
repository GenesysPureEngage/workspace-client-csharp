...
namespace Genesys.Workspace.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VoicedialData :  IEquatable<VoicedialData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicedialData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VoicedialData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VoicedialData" /> class.
        /// </summary>
        ...
        public VoicedialData(string Destination = default(string), string Location = default(string), int? MakeCallType = default(int?), List<Kvpair> UserData = default(List<Kvpair>), List<Kvpair> Reasons = default(List<Kvpair>), List<Kvpair> Extensions = default(List<Kvpair>), string OutboundCallerId = default(string))
        {
            // to ensure "Destination" is required (not null)
            if (Destination == null)
            {
                throw new InvalidDataException("Destination is a required property for VoicedialData and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as VoicedialData);
        }

        /// <summary>
        /// Returns true if VoicedialData instances are equal
        /// </summary>
        /// <param name="other">Instance of VoicedialData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoicedialData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
