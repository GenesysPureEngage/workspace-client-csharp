...
namespace Genesys.Workspace.Model
{
    ...
    public partial class DeleteFromConferenceData :  IEquatable<DeleteFromConferenceData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as DeleteFromConferenceData);
        }

        /// <summary>
        /// Returns true if DeleteFromConferenceData instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteFromConferenceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteFromConferenceData input)
        {
            if (input == null)
                return false;
