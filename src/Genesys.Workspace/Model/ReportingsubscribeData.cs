...
namespace Genesys.Workspace.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportingsubscribeData :  IEquatable<ReportingsubscribeData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportingsubscribeData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReportingsubscribeData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportingsubscribeData" /> class.
        /// </summary>
        ...
        public ReportingsubscribeData(string SocketId = default(string), List<string> Statistics = default(List<string>))
        {
            ...
            if (Statistics == null)
            {
                throw new InvalidDataException("Statistics is a required property for ReportingsubscribeData and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReportingsubscribeData);
        }

        /// <summary>
        /// Returns true if ReportingsubscribeData instances are equal
        /// </summary>
        /// <param name="other">Instance of ReportingsubscribeData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportingsubscribeData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
