...
namespace Genesys.Workspace.Model
{
    ...
    public partial class VoicemakecallData :  IEquatable<VoicemakecallData>, IValidatableObject
    {
        ...
        public VoicemakecallData(List<Kvpair> UserData = default(List<Kvpair>), List<Kvpair> Reasons = default(List<Kvpair>), string OutboundCallerId = default(string), string Destination = default(string), List<Kvpair> Extensions = default(List<Kvpair>), string Location = default(string))
        {
