...
namespace Genesys.Workspace.Model
{
    ...
    public partial class VoicecallsidreconnectData :  IEquatable<VoicecallsidreconnectData>, IValidatableObject
    {
        ...
        public VoicecallsidreconnectData(string CurrentConnId = default(string), List<Kvpair> Reasons = default(List<Kvpair>), List<Kvpair> Extensions = default(List<Kvpair>))
        {
            // to ensure "CurrentConnId" is required (not null)
            if (CurrentConnId == null)
            {
                throw new InvalidDataException("CurrentConnId is a required property for VoicecallsidreconnectData and cannot be null");
            }
            else
            {
