...
namespace Genesys.Workspace.Model
{
    ...
    public partial class StatisticsRegisterDataData :  IEquatable<StatisticsRegisterDataData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as StatisticsRegisterDataData);
        }

        /// <summary>
        /// Returns true if StatisticsRegisterDataData instances are equal
        /// </summary>
        /// <param name="input">Instance of StatisticsRegisterDataData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatisticsRegisterDataData input)
        {
            if (input == null)
                return false;
